...
export default function WfhTab({ requests }) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 p-4 transition-all duration-300">
      {/* Recent */}
      <div>
        <h3 className="text-sm font-medium mb-3">
          Recent Requests <span className="text-gray-400">( {requests.recent.length} )</span>
        </h3>
      ...
      <div>
        <h3 className="text-sm font-medium mb-3">
          Approved Requests <span className="text-gray-400">( {requests.approved.length} )</span>
        </h3>
        <div className="flex flex-col gap-4">
      ...
      <div>
        <h3 className="text-sm font-medium mb-3">
          Rejected Requests <span className="text-gray-400">( {requests.rejected.length} )</span>
        </h3>
        <div className="flex flex-col gap-4">
