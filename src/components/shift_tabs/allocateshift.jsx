...
const FilterBar = ({ employees = [] }) => {
  ...
  return (
    <div className="flex flex-wrap items-end gap-3 mb-3 p-3 mt-1 rounded-lg relative">
      ...
      {/* Date Filters */}
      {["From", "To"].map((label, i) => (
        <div key={i} className="min-w-[100px] w-[115px]">
...
// ===== Shift Calendar With Unified Scroll =====
const ShiftCalendar = ({ employees, days }) => (
  <div className="overflow-x-auto ">
    <div className="min-w-[800px] max-h-[500px] overflow-y-auto custom-scroll rounded-xl shadow-sm ">
      {/* Header */}
      <div className="grid grid-cols-[minmax(160px,_1fr)_repeat(7,_minmax(95px,_0.7fr))] text-[11px] bg-white sticky top-0 z-10 border-b">
        ...
        {days.map((day) => (
          <div
            key={day}
            className="p-2 font-semibold text-gray-600 text-center border-r last:border-none bg-white"
          >
            {day}
          </div>
        ))}
